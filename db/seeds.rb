...
User.create(employee_id: '10122', name: 'Cassie Rochin', username: 'crochin', email: 'crochin@nswpaws.gov.au', password: 'crochin', password_confirmation: 'crochin', admin: 'false', date_joined: '2007-04-07', person_type_id: '5')
User.create(employee_id: '10641', name: 'Karmen Gin', username: 'kgin', email: 'kgin@nswpaws.gov.au', password: 'kgin1234', password_confirmation: 'kgin1234', admin: 'false', date_joined: '2004-09-04', person_type_id: '1')
